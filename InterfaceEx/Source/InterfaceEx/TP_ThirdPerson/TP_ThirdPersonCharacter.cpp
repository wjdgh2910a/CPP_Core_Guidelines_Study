...
ATP_ThirdPersonCharacter::ATP_ThirdPersonCharacter()
{
	...
	//¡÷∏‘ HitBox ∏∏µÈ±‚
	LeftHitBox = CreateDefaultSubobject<UArrowComponent>(TEXT("LeftHitBox"));
	LeftHitBox->AttachToComponent(GetMesh(), FAttachmentTransformRules(EAttachmentRule::SnapToTarget, true),TEXT("hand_l"));
